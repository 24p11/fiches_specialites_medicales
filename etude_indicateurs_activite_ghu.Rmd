...
L'attribution de la spécialité médicale est réalisée pour chaque séjour de la base nationale. La méthode d'attribution de la spécialité est basée sur les données observées à l'AP-HP. La répartition des séjours en spécialité à l'AP-HP est étudiée grâce à une variables disponible dans le fichier structure qui classe tous les unités de soin selon une typologie proche de la notion de spécialité médicale. Les règles d'attribution de la spécialité issues de ces analyses utilisent des critères d'âge et de racine de GHM, qui dépend elle-même du dignostic principal et du mode de prise en charge (médecine, chirurgie, interventionnel). 
